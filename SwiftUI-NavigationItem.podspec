#
#  Be sure to run `pod spec lint SwiftUI-NavigationItem.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "SwiftUI-NavigationItem"
  spec.version      = "0.0.1"
  spec.summary      = "📲 Access NavigationItem in SwiftUI"
  ...
  spec.homepage     = "http://EXAMPLE/SwiftUI-NavigationItem"
  ...
  spec.source       = { :git => "https://github.com/aswathr/SwiftUI-NavigationItem", :tag => "#{spec.version}" }
